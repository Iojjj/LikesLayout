 ...
 */
public class LikesRelativeLayout extends RelativeLayout implements LikesDrawer.LikesLayout {
    ...
    private void init(@NonNull Context context, @Nullable AttributeSet attrs) {
        ...
        if (attrs != null) {
            mDefaultAttributes = LikesAttributes.create(context, attrs, LikesAttributes.LAYOUT_TYPE_RELATIVE);
     ...
     */
    public static class LayoutParams extends RelativeLayout.LayoutParams implements LikesDrawer.LikesLayoutParams {

        private final LikesAttributes mAttributes;

        public LayoutParams(Context c, AttributeSet attrs) {
            super(c, attrs);
            mAttributes = LikesAttributes.create(c, attrs, LikesAttributes.LAYOUT_TYPE_RELATIVE);
        }
